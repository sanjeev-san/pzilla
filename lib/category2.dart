...
class Category2 extends StatefulWidget {
  ...
  const Category2({super.key, required this.onItemTapped});
...
class _Category2State extends State<Category2> {
  Future<void> getNextPage() async {
    try {
      final url = Uri.parse(
          "${Credentials.rootAddress}/wp-json/wc/v3/products?per_page=4&page=$category2_page&categories=Gadgets");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GridView.builder(
        itemCount: category2_items.length,
