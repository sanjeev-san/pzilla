...
class Category1 extends StatefulWidget {
  ...
  const Category1({super.key, required this.onItemTapped});
...
class _Category1State extends State<Category1> {
  Future<void> getNextPage() async {
    try {
      final url = Uri.parse(
          "${Credentials.rootAddress}/wp-json/wc/v3/products?per_page=4&page=$category1_page&categories=Electronics");
      ...
      //done the array just adds nothing, show snackbar of error
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GridView.builder(
        itemCount: category1_items.length,
